...
execute positioned ~-0.05 0 ~-0.05 as @e[dx=0.1,dy=0.1,dz=0.1,tag=pcd_lazy_query] unless score GAMETIME pcd_tmp = @s pcd_gametime run function zzz_chunkdisplay:update_lazy_query
