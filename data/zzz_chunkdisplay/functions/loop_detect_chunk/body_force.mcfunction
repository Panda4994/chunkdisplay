...
execute at @e[tag=pcd_chunkpos,limit=1] store result score FORCE pcd_tmp run forceload query ~ ~
...
#execute store result score POS_X pcd_tmp run data get entity @e[tag=pcd_chunkpos,limit=1] Pos[0] 0.0625
#execute store result score POS_Z pcd_tmp run data get entity @e[tag=pcd_chunkpos,limit=1] Pos[2] 0.0625
